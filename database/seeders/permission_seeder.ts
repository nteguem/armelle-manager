  ...
  async run() {
    ...
    const permissionsByModule = {
      ...
      igs: [
        {
          name: 'igs.list',
          displayName: 'Lister les calculs IGS',
          description: 'Voir la liste des calculs IGS',
        },
        {
          name: 'igs.view',
          displayName: 'Voir un calcul IGS',
          description: "Voir les détails d'un calcul IGS",
        },
        {
          name: 'igs.stats',
          displayName: 'Statistiques IGS',
          description: 'Voir les statistiques des calculs IGS',
        },
      ],
      reports: [
        {
